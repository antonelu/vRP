...
CT(function()
    local ticks = 1000
    local blipe = AddBlipForCoord(-1182.9156494141,-883.75225830078,13.759816169739)
    SetBlipSprite(blipe, 438)
    SetBlipColour(blipe, 5)
    SetBlipAsShortRange(blipe, true)
    BeginTextCommandSetBlipName("STRING")
    AddTextComponentString("~w~Burger Shot ~g~[JOB]")
    EndTextCommandSetBlipName(blipe)
